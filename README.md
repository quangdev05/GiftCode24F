![GitHub release (latest by date)](https://img.shields.io/github/v/release/quangdev05/GiftCode24F)
...
### **Note:** The original version ([GiftCode24)](https://github.com/quangdev05/GiftCode24/) from version 3.0.0 has been supported for use on servers running fork Folia, so GiftCode24F (GiftCode24 Folia) will stop updating.
